import { RoomEngineRoomAdEvent, RoomEngineTriggerWidgetEvent, RoomEngineUseProductEvent, RoomId, RoomSessionErrorMessageEvent, RoomZoomEvent } from '@nitrots/nitro-renderer';
...
import { ChatInputWindowView } from './chat-input/ChatInputWindowView';
...
import { KbChatBridgeView } from './chat-input/KbChatBridgeView';
...
export const RoomWidgetsView: FC<{}> = props => {
    ...
    useRoomEngineEvent(
        ...
        (event: RoomEngineTriggerWidgetEvent | RoomEngineRoomAdEvent | RoomEngineUseProductEvent) => {
